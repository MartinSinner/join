...
function buildContactUrl(contactId) {
  return `https://join-martinsinner-default-rtdb.europe-west1.firebasedatabase.app/Data/Contacts/${contactId}.json`;
}
...
async function deleteContactInDatabase(contactId) {
  const url = `https://join-martinsinner-default-rtdb.europe-west1.firebasedatabase.app/Data/Contacts/${contactId}.json`;
